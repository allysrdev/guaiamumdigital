                ...
                >
                    ...
                    <nav className='hidden md:flex items-center gap-1'>
                        {['Início', 'Portfólio', 'Serviços', 'Processo'].map((item) => (
                            <button 
                                ...
                                className={`relative px-5 py-2 text-sm font-bold tracking-tight transition-all duration-500 group overflow-hidden ${
                            ...
                            >
                                ...
                                <span className={`absolute inset-0 scale-x-0 group-hover:scale-x-100 transition-transform duration-500 origin-left rounded-full ${
                    ...
                    <button 
                        className={`md:hidden p-2 transition-colors ${
                            scrolled && isDarkSection ? 'text-white/80 hover:text-white' : 'text-foreground/80 hover:text-foreground'
                        }`}
